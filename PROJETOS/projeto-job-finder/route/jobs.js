...
// Detalhes da vaga -> view/1, view/2, etc.
// Define a rota para exibir os detalhes de uma vaga específica
router.get("/view/:id", (req, res) =>
  job
    ...
    .then((job) => {
      res.render("view", { job });
    }).catch(error => console.error("Erro ao buscar a vaga:", error) || res.status(500).send("Erro ao buscar a vaga"))
);
